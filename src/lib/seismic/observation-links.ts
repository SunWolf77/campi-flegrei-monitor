...
export function observationLinks(nodeId: FocusNodeId): ObservationLink[] {
  if (nodeId === "campi-flegrei") {
    return [
      ...
      {
        id: "tomsk",
        title: "Tomsk Schumann amplitude",
        subtitle: "SOSRFF sra.jpg · live ELF chart (sch.png retired)",
        href: "https://sosrff.tsu.ru/new/sra.jpg",
        group: "resonance",
      },
      {
        id: "tomsk-spec",
        title: "Tomsk spectrogram",
        subtitle: "fc_fsr1.jpg · frequency structure",
        href: "https://sosrff.tsu.ru/new/fc_fsr1.jpg",
        group: "resonance",
      },
      {
        id: "resonanceone",
        title: "ResonanceOne SR index",
        subtitle: "Numeric Tomsk-attributed activity index API",
  ...
  return [
    ...
    },
    {
      id: "tomsk",
      title: "Tomsk Schumann amplitude",
      subtitle: "SOSRFF sra.jpg · live ELF",
      href: "https://sosrff.tsu.ru/new/sra.jpg",
      group: "resonance",
    },
  ];
